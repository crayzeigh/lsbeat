...
```
git remote set-url origin https://github.com/crayzeigh/lsbeat
...
```
mkdir -p ${GOPATH}/github.com/crayzeigh
cd ${GOPATH}/github.com/crayzeigh
git clone https://github.com/crayzeigh/lsbeat
```
